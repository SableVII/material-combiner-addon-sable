...
def _materials_list(scn: Scene, m_col: bpy.types.UILayout) -> None:
    ...
    col.separator()
    col.label(text='Blushables Texture Name')
    col.prop(scn, 'smc_sable_blushables_texture_name', text='')
    col.prop(scn, 'smc_sable_create_blushables_texture')
    col.separator()
    ...
    col.separator()
    col.label(text='Emotes Texture Name')
    col.prop(scn, 'smc_sable_emotes_texture_name', text='')
    col.prop(scn, 'smc_sable_create_emotes_texture')
    col.separator()    
