...
def _materials_list(scn: Scene, m_col: bpy.types.UILayout) -> None:
    ...
    col.separator()
    col.label(text='Eye Reflections Texture Name')
    col.prop(scn, 'smc_sable_eyereflections_texture_name', text='')
    col.prop(scn, 'smc_sable_create_eyereflections_texture')
    col.separator()
    col.label(text='Emissives Texture Name')
    col.prop(scn, 'smc_sable_emissives_texture_name', text='')
    col.prop(scn, 'smc_sable_create_emissives_texture')
    col.separator()
    ...
    col.separator()
    col.label(text='HUD Elements Texture Name')
    col.prop(scn, 'smc_sable_HUDelements_texture_name', text='')
    col.prop(scn, 'smc_sable_create_HUDelements_texture')
    col.separator()                
